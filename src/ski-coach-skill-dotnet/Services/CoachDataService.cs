...
/// </summary>
/// <remarks>
/// This is a faithful .NET port of <c>ski-coach-agent-python</c>'s <c>CoachService</c>
...
/// behavior of <c>ski-coach-agent-python</c> today, not something introduced by this port. To faithfully
...
public class CoachDataService
{
        ...
        SlopeMetadata metadata)
    {
        ...
        // NOTE: the data-generator's actual "avalanche_risk_index" is a 0-1 float (see safety-skill-dotnet /
        // safety-agent-python), while this comparison assumes a 0-10 scale — another pre-existing mismatch in
