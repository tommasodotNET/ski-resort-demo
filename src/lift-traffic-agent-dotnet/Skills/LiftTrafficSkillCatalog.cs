...
public static class LiftTrafficSkillCatalog
{
    ...
    /// <summary>The Agent Framework / A2A agent name (matches <c>AddAIAgent("lifttrafficagent", ...)</c> in Program.cs).</summary>
    public const string AgentName = "lifttrafficagent";
