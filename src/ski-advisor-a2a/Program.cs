...
var weatherAgent = ResolveA2AAgent(Environment.GetEnvironmentVariable("services__weatheragenta2a__https__0") != null
    ? "services__weatheragenta2a__https__0"
    : "services__weatheragenta2a__http__0");
var liftAgent = ResolveA2AAgent(Environment.GetEnvironmentVariable("services__lifttrafficagenta2a__https__0") != null
        ? "services__lifttrafficagenta2a__https__0"
        : "services__lifttrafficagenta2a__http__0");
var safetyAgent = ResolveA2AAgent(Environment.GetEnvironmentVariable("services__safetyagenta2a__https__0") != null
        ? "services__safetyagenta2a__https__0"
        : "services__safetyagenta2a__http__0");
var coachAgent = ResolveA2AAgent(Environment.GetEnvironmentVariable("services__skicoachagenta2a__https__0") != null
        ? "services__skicoachagenta2a__https__0"
        : "services__skicoachagenta2a__http__0");
...
var agent = foundryProjectClient.AsAIAgent(
    ...
    name: Environment.GetEnvironmentVariable("AGENT_NAME") ?? "skiadvisora2a",
